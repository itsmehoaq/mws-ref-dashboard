...
type Action = "pick" | "ban" | "protect" | "unpick"
                ...
                {actions.map((action) => (
                  action === "unpick" ? (
                    <Button
                      ...
                      size="sm"
                      variant="outline"
                      className="w-full text-xs border-destructive/40 text-destructive/80 hover:border-destructive hover:bg-destructive/5 hover:text-destructive"
